...
const STRINGS = {
  en: {
    ...
    hero_body: "FASAL brings weather, sale, and market data into one place, so you can decide what to sow, when to water, and where to sell — without the guesswork.",
    hero_cta_primary: "Login",
